...
#ROOT_DIR = r'C:\Users\smoha\Downloads\tutorials-master\Mask_RCNN-master\Mask_RCNN-master'
#ROOT_DIR = r'C:\Users\smoha\Downloads\Mask_RCNN-295c802f0bebbc4a34ec4855f4960a52a701271d\Mask_RCNN-295c802f0bebbc4a34ec4855f4960a52a701271d'

ROOT_DIR = r'C:\Users\smoha\Downloads\tesseract\tesseract/Mask_RCNN'
...
class CigButtsConfig(Config):
    ...
    RPN_ANCHOR_SCALES = (4,8,16, 32, 64)#(8, 16, 32, 64, 128)
...
dataset_train.load_data(r'C:\Users\smoha\Downloads\tesseract\tesseract\venv\Include\cig_butts\New Folder\cig_butts\trainA\coco_instances.json', r'C:\Users\smoha\Downloads\tesseract\tesseract\venv\Include\cig_butts\New Folder\cig_butts\trainA\images')
dataset_train.prepare()

dataset_val = CocoLikeDataset()
dataset_val.load_data(r'C:\Users\smoha\Downloads\tesseract\tesseract\venv\Include\cig_butts\New Folder\cig_butts\valA\coco_instances.json', r'C:\Users\smoha\Downloads\tesseract\tesseract\venv\Include\cig_butts\New Folder\cig_butts\valA\images')
dataset_val.prepare()
...
#                  epochs=5,
#                  layers='heads') # 5 epocs and learning rate config.learning_rate
#
#
#
# # # #end_train = time.time() config.LEARNING_RATE #5
...
real_test_dir = r'C:\Users\smoha\Downloads\tesseract\tesseract\venv\Include\cig_butts\New Folder\cig_butts/real_testA'
